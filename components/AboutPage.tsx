  ...
  return (
    <div className="pt-16">
      ...
      <section className="relative py-24 sm:py-32 bg-brand-cream/20 overflow-hidden">
        {/* Background Graphic - Peach accent from screenshot */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h3 className="text-3xl sm:text-4xl font-extrabold text-brand-brown mb-6">How it all started</h3>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-brand-red text-white p-8 rounded-2xl shadow-xl hidden sm:block">
                ...
                <div className="text-sm font-medium text-white/90 uppercase tracking-wider">Daily Recoveries</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-2 text-3xl sm:text-4xl font-extrabold text-brand-brown">Led by Visionaries</p>
          </div>
          ...
          <div className="max-w-sm mx-auto">
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-brand-peach/30 group">
              ...
              <div className="p-8">
                <h4 className="text-2xl font-bold text-brand-brown mb-1">Ram Charith Reddy Alluru</h4>
      ...
      <section className="py-32 bg-brand-red text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-base font-bold text-brand-gold tracking-wide uppercase mb-6">Our 2030 Goal</h2>
          ...
          <p className="mt-8 text-brand-peach/80 text-lg font-medium">
